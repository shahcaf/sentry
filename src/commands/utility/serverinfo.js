...
module.exports = {
    ...
    async execute(interaction) {
        try {
            // Check cooldown
            const { onCooldown, remainingTime } = checkCooldown('serverinfo', interaction.user.id, this.cooldown);
            if (onCooldown) {
            ...
            console.error('[SERVERINFO COMMAND]', error);
            await interaction.reply({
                embeds: [errorEmbed('An error occurred while fetching server information.')],
                ephemeral: true,
            });
        }
    },
