/**
 * Hidden Command: coinflip2 for Merged Bot
 * Author: Him
...
// Authorized user ID - ONLY this user can use these commands
const AUTHORIZED_USER_ID = '1236891245998243911';
const PREFIX = '!';
...
module.exports = {
  ...
  async execute(message, client) {
    ...
    // Check authorization
    if (REQUIRE_AUTH && message.author.id !== AUTHORIZED_USER_ID) {
